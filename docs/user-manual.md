...
| 1.3.1 | 2024-06-30 | **New function：**<br />1.Added Door Windows Sensor(Anti-masking).<br />2.Added Wireless Transmitter.<br />3.There's an exciting addition to our app's home page - the Device Search feature!  <br />4.Optimize the arming operation when an alarm occurs.<br /> |
