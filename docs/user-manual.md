...
> |   Room Belongs to    | ![Indoor Siren - Signal Strength Test](https://dusunprj.oss-us-west-1.aliyuncs.com/roombanker/Indoor%20Siren%20-%20Signal%20Strength%20Test.jpg) | You can select one of the rooms created before and then link the XXX to.  <br />**When linked to a specific room, the XXX  will be displayed on the product list of the room,  and the XXX could begin for detecting when the room is armed.* |
> |       Find Me        | ![Keypad - Signal Strength Test](https://dusunprj.oss-us-west-1.aliyuncs.com/roombanker/Keypad%20-%20Signal%20Strength%20Test.jpg) | A function that used to find your  XXX among numerous devices. When you enable this function, the  indicator in XXX will  flash green to help you find the target device  quickly. |
> | Signal Strength Test | ![Outdoor Siren - Signal Strength Test](https://dusunprj.oss-us-west-1.aliyuncs.com/roombanker/Outdoor%20Siren%20-%20Signal%20Strength%20Test.jpg) | A function that used to check the signal strength between XXX and hub at the tested place, which is designed to help you choose the right place for installation.     <br />When you enable this function, you  can check the signal strength by watching the indicator in XXX and the feedback in  app. |
> |  Installation Test   | ![Water Leak - Signal Strength Test](https://dusunprj.oss-us-west-1.aliyuncs.com/roombanker/Water%20Leak%20-%20Signal%20Strength%20Test.jpg) | A function that used to test whether the XXX is installed properly.     <br />When you enable this function, you  can XXXXXX to  test if the XXX  can detect and trigger an alarm properly. The indicator will flash red when it  detects successfully. |
