...
PIN code +[![资源 6@5x](https://dusunprj.oss-us-west-1.aliyuncs.com/%E8%B5%84%E6%BA%90%206@5x.png)/  ]. The blue indicator on the keypad turns on when the system is armed . If it fails, the buzzer will beep three times.
